            ...
            for(var i=1 ; i<=16 ; i++){
                ...
                object.traverse( function (child) {
                    if( child instanceof THREE.Mesh){                  
                        ...
                        mesh[i].name = i;
                        mesh[i].rotation.set(-0.18,0.76,-1.36);                          
                        objects.push(mesh[i]);
                        groupe.add(mesh[i]);
                        scene.add(mesh[i]);
                    }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh1.name = 1;
                 mesh1.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh1);
                 groupe.add(mesh1);
                 scene.add(mesh1);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh2.name = 2;
                mesh2.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh2);
                 groupe.add(mesh2);
                 scene.add(mesh2);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh3.name = 3;
                 mesh3.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh3);
                 groupe.add(mesh3);
                 scene.add(mesh3);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh4.name = 4;
                mesh4.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh4);
                 groupe.add(mesh4);
                 scene.add(mesh4);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh5.name = 5;
               mesh5.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh5);
                 groupe.add(mesh5);
                 scene.add(mesh5);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh6.name = 6;
                 mesh6.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh6);
                 groupe.add(mesh6);
                 scene.add(mesh6);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh7.name = 7;
                 mesh7.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh7);
                 groupe.add(mesh7);
                 scene.add(mesh7);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh8.name = 8;
                mesh8.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh8);
                 groupe.add(mesh8);
                 scene.add(mesh8);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh9.name = 9;
                mesh9.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh9);
                 groupe.add(mesh9);
                 scene.add(mesh9);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh10.name = 10;
                 mesh10.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh10);
                 groupe.add(mesh10);
                 scene.add(mesh10);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh11.name =11;
                 mesh11.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh11);
                 groupe.add(mesh11);
                 scene.add(mesh11);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh12.name = 12;
                 mesh12.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh12);
                 groupe.add(mesh12);
                 scene.add(mesh12);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh13.name = 13;
                 mesh13.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh13);
                 groupe.add(mesh13);
                 scene.add(mesh13);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh14.name = 14;
                 mesh14.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh14);
                 groupe.add(mesh14);
                 scene.add(mesh14);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh15.name = 15;
                 mesh15.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh15);
                 groupe.add(mesh15);
                 scene.add(mesh15);
            }       
        ...
        object.traverse( function (child) {
            if( child instanceof THREE.Mesh){                  
                geometry = new THREE.Geometry().fromBufferGeometry(child.geometry);
                 ...
                 mesh16.name = 16;
                 mesh16.rotation.set(-0.18,0.76,-1.36);                          
                 objects.push(mesh16);
                 groupe.add(mesh16);
                 scene.add(mesh16);
            }       
